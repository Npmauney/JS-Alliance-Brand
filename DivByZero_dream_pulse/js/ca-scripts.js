...
function toggleColors() {
    ...
    let elem = document.querySelectorAll('.tm-white-rect');
    
    for (let i=0; i<elem.length; i++){
        elem[i].classList.add('tm-blue-rect')
        elem[i].classList.remove('tm-white-rect')
    }
};
...
function hideElement() {
 ...
 function addText() {
    ...
    aboutPara2.textContent = 'We deliver the best service this side of creation'
